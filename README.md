...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-wind-27aa
```

A live public deployment of this template is available at [https://gentle-wind-27aa.templates.workers.dev](https://gentle-wind-27aa.templates.workers.dev)
